    ...
    <div className="flex flex-col bg-white ">
      ...
      <div className="w-full h-full bg-white  ">
        <div className="flex flex-row gap-2 h-52">
          <div className="relative w-14 ml-10 mt-20 bg-[#826a45] h-14 rounded-2xl">
            <img className="absolute w-10 h-10 ml-2 mt-2 " src="https://cdn-icons-png.flaticon.com/128/9736/9736371.png" />
          </div>
          <div className="relative w-14 mt-20 bg-gray-400 h-14 rounded-2xl">
            <img className="absolute w-10 h-10 ml-2 mt-2" src="https://cdn-icons-png.flaticon.com/128/3602/3602109.png" />
          </div>
          <div className=" ml-auto  mt-20 flex flex-row gap-5">
            <div>
              <p className="text-gray-600 font-mono ">Showing 1–8 of 20 results</p>
            </div>
      ...
      <div className="w-full h-40 bg-gradient-to-r from-white to-gray-50 flex items-center justify-center gap-6 shadow-md rounded-2xl border border-gray-200 ">
        <p className="font-sans text-2xl sm:text-3xl text-gray-700 tracking-wide">
          Number of items added to cart:
        </p>
        <h1 className="text-3xl sm:text-4xl font-bold text-emerald-600 drop-shadow-sm">
          {count}
        </h1>
      </div>
      <Footer />
